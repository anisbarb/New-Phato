...
import { PLACES } from "../lib/corridor";
  ...
  return (
    <div className="phato-search-wrap">
      <div className={`phato-search-bar ${focused ? "focused" : ""}`}>
        <svg className="phato-search-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round">
        ...
        <input
          ...
          onFocus={() => { setFocused(true); if (selectedDestination) setQuery(""); }}
