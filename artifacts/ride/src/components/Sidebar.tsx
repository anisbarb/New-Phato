...
export default function Sidebar({ open, onClose, role, onBecomeDriver, onBackToPassenger }: Props) {
  const items: SidebarItem[] = [
    { icon: <IconMap />, label: "Map", onClick: onClose },
    { icon: <IconClock />, label: "Trip History", onClick: onClose },
    { icon: <IconStar />, label: "Saved Places", onClick: onClose },
    { icon: <IconBell />, label: "Notifications", onClick: onClose },
    { icon: <IconSettings />, label: "Settings", onClick: onClose },
    { icon: <IconHelp />, label: "Help", onClick: onClose },
    { icon: <IconInfo />, label: "About Phato", onClick: onClose },
  ];
        ...
        <>
          ...
          >
            ...
            <nav className="phato-sidebar-nav">
              {items.map((item) => (
                <button key={item.label} className="phato-sidebar-item" onClick={item.onClick}>
